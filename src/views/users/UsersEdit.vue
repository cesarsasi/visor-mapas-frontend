...
<main class="container-1-1">
    ...
    <div class="container-body">
        ...
        <div id="permissions">
            <input v-if="user.permissions" type="checkbox" id="checkbox" v-model="user.permissions.users">
            <label for="checkbox">Usuarios</label>
            <br>
            <input v-if="user.permissions" type="checkbox" id="checkbox" v-model="user.permissions.layers">
            <label for="checkbox">Capas</label>
            <br>
            <input v-if="user.permissions" type="checkbox" id="checkbox" v-model="user.permissions.geo">
            <label for="checkbox">Geoprocesos</label>
            <br>
            <input v-if="user.permissions" type="checkbox" id="checkbox" v-model="user.permissions.maps">
            <label for="checkbox">Mapas</label>
            <br>
            <input v-if="user.permissions" type="checkbox" id="checkbox" v-model="user.permissions.visor">
        ...
        <div class="container-action-left" style="justify-content: start;">
            ...
            <button class="btn btn-secondary" v-on:click="onClickGoNext()">Actualizar usuario</button>
        </div>
...
export default{
    ...
    mounted () {
        ...
        const isUnique = (value) => {
            ...
            .then(function (response) {
                if (that.actualUsername == value) {
                    return {
                        valid: true,
                        data: {
                            message: "Es el mismo correo ya registrado"
                        }
                    };
                }
                return {
